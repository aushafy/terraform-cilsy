...
module "rds" {
  ...
  identifier = "rdswordpress" # CHANGE ME!
  ...
  name     = "dbwordpressprod" # CHANGE ME! nama dari initial database yang mau dibuat
  ...
  final_snapshot_identifier = "snapshotrdswordpress" # CHANGE ME!
